...
{
    /// <summary>
    /// The list of VirtualKeyCodes (from http://inputsimulator.codeplex.com/SourceControl/latest#WindowsInput/Native/VirtualKeyCode.cs)
    /// </summary>
    public enum VirtualKey //: UInt16
    {
        /// <summary>
        /// Reprensents no virtual key.
        /// </summary>
        None = 0x00,
